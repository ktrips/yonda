...
def _build_ai_recommend_system_prompt(form_prefs: dict) -> str:
...
def api_ai_recommend():
    ...
    if is_init:
        chat_messages.append({"role": "user", "content": "こんにちは。AI推しをお願いします。まず「AI推しへようこそ！5つの質問で、あなたにピッタリな本を推すので、短くてもいいので答えて下さいね。」と挨拶した後、最初の質問（Q1. 今の気分）をしてください。"})
    elif user_message:
