...
// ジャンル文字列のキーワードでカテゴリを決定（上から優先順位順に判定）
const TAG_CATEGORY_GENRE_KEYWORDS = {
  // ─── ノンフィクション（フィクション系より先に判定） ──────────
  'ノンフィクション': [
    'ノンフィクション', 'ノンフィクション・ドキュメンタリー', '犯罪ノンフィクション',
    'エッセイ', '随筆', 'コラム', '日記', 'エッセイ・紀行', 'エッセイ・随筆',
    '伝記', '自伝', '回顧録', '評伝', '人物', '有名人', '著名人', '芸能人',
    'ルポ', 'ドキュメンタリー', '体験記', 'ルポルタージュ', '告白', '手記',
    'memoir', 'essay', 'biography', 'nonfiction', 'true crime',
  ],
  // ─── フィクション 3分類 ──────────────────────────────────────
  'ジャンル小説': [
    'ミステリー・サスペンス', 'sf・ファンタジー', 'ミステリー・サスペンス・ホラー',
    'ミステリー', '推理', 'サスペンス', 'スリラー', 'ホラー', 'sf', 'ファンタジー',
    '異世界', 'ロマンス', '恋愛小説', '時代小説', '大衆小説', 'ライトノベル',
    'コミック', '漫画', '絵本', '児童書',
  ],
  '現代文学': [
    '現代文学', '現代小説', '一般小説', '国内小説', '現代日本文学', 'contemporary fiction',
    '小説', 'フィクション', 'fiction',
  ],
  '文学・その他小説': [
    '純文学', '文芸', '文学・小説', '日本文学', '外国文学', '海外文学',
    '歴史小説', '児童文学', '詩', '戯曲', '文学',  'drama',
  ],
  // ─── ビジネス 2分類 ──────────────────────────────────────────
  'ビジネス': [
    'ビジネス・キャリア',
    'ビジネス', '経営', 'マネジメント', 'マーケティング', '起業', 'キャリア',
    '仕事術', '営業', '会計', '財務', 'プレゼン', 'コミュニケーション',
    'リーダーシップ', 'management', 'business',
  ],
  '自己啓発': [
    '自己啓発・マインドフルネス',
    '自己啓発', '習慣', 'マインドフルネス', '瞑想', '成功法則', '目標達成',
    '思考法', 'モチベーション', 'ポジティブ', 'メンタル強化',
    '人間関係', 'スピリチュアル', '心理', '脳科学', '認知', '教養',
...
const CATEGORY_TAG_BLOCKLIST = {
  'ジャンル小説':     new Set(['ジャンル小説', '大衆小説', 'エンターテインメント', 'エンタメ', 'フィクション', 'fiction', '小説', '漫画', 'コミック']),
  '現代文学':         new Set(['現代文学', '現代小説', '一般小説', '小説', 'フィクション', 'fiction', '現代', '国内小説']),
  '文学・その他小説': new Set(['文学', '小説', '文芸', 'フィクション', 'fiction', '文学・小説', 'ドラマ', 'drama']),
  'ノンフィクション': new Set(['ノンフィクション', 'nonfiction', 'ノンフィクション・ドキュメンタリー', 'ドキュメンタリー', 'エッセイ', 'essay', '随筆', '伝記']),
  'ビジネス':         new Set(['ビジネス', 'business', 'ビジネス・キャリア', 'ビジネス全般']),
  '自己啓発':         new Set(['自己啓発', 'self-help', '自己啓発・マインドフルネス', 'マインドフルネス']),
  '政治・経済':       new Set(['政治', '経済', '社会・政治', '人文・思想', '資産・金融']),
  '社会・ライフ':     new Set(['社会', 'ライフ', 'ライフスタイル', 'life', 'lifestyle', 'ライフスタイル・健康', 'アート・エンターテインメント']),
  'テクノロジー・科学': new Set(['テクノロジー', 'it', 'science', 'technology', 'コンピュータ・テクノロジー', 'サイエンス・テクノロジー']),
};
...
const DETAIL_TAG_PATTERNS = {
  'ジャンル小説': [
    ...
    { tag: '恋愛・ロマンス',       words: ['恋愛', '恋人', 'ロマンス', '片思い', '初恋', '恋心', '愛し', '結婚', 'love', 'romance'] },
    ...
    { tag: '社会派・格差',         words: ['格差', '差別', '貧困', '社会問題', '不平等', 'いじめ', '孤独', '孤立'] },
  ],
  '現代文学': [
    { tag: '恋愛・ロマンス',   words: ['恋愛', '恋人', 'ロマンス', '片思い', '初恋', '結婚', 'プロポーズ', '交際', '告白', 'love', 'romance'] },
  ...
  '文学・その他小説': [
    ...
    { tag: '海外文学',           words: ['海外', '外国', '翻訳', '英米', 'ヨーロッパ', 'アメリカ文学', 'イギリス文学', 'フランス文学'] },
  ...
  'ノンフィクション': [
    { tag: 'エッセイ・随筆',       words: ['エッセイ', '随筆', '日記', '雑感', '考察', 'コラム', 'essay'] },
    { tag: '伝記・自伝',           words: ['伝記', '自伝', '回顧録', '評伝', '生涯', '人物', 'memoir', 'biography'] },
    { tag: '有名人・著名人',       words: ['有名人', '著名人', '芸能人', '政治家', '経営者', '起業家', '作家', 'celebrity'] },
    { tag: '犯罪ノンフィクション', words: ['犯罪', '真実の事件', '実話', '冤罪', 'true crime', '事件の真相'] },
    { tag: 'ルポ・調査報道',       words: ['ルポ', 'ルポルタージュ', '調査', '取材', 'ジャーナリズム', 'ドキュメント'] },
    { tag: '歴史ノンフィクション', words: ['歴史', '史実', '記録', '出来事', '時代', 'history'] },
    { tag: '旅・体験記',           words: ['旅', '旅行', '体験', '冒険', '探検', 'travel'] },
    { tag: '社会・問題提起',       words: ['社会問題', '格差', '差別', '貧困', '環境問題', '提言'] },
    { tag: '科学・自然',           words: ['科学', '自然', '生物', '動物', '植物', '宇宙', 'nature', 'science'] },
    { tag: '戦争・政治',           words: ['政治', '戦争', '外交', '国際', '歴史', 'politics', 'war'] },
  ],
  'ビジネス': [
  ...
  '社会・ライフ': [
    ...
    { tag: '社会問題・格差',         words: ['格差', '差別', '貧困', '社会問題', '不平等', 'いじめ', '孤独', '孤立'] },
    { tag: '環境・サステナブル',     words: ['環境', 'サステナブル', 'エコ', 'ゼロウェイスト', '気候変動', 'sustainable'] },
    { tag: '教育・子育て',           words: ['教育', '学習', '学校', '塾', '子ども', 'education'] },
  ],
  'テクノロジー・科学': [
