...
const TAG_CATEGORY_GENRE_KEYWORDS = {
  ...
  '文学・その他小説': [
    ...
    '現代文学', '歴史小説', '児童文学', '詩', '戯曲',
    // 小説・フィクション全般（大衆小説に当てはまらなかった場合）
    '小説', 'フィクション', '文学', 'fiction', 'drama',
  ],
  'ノンフィクション': [
    'ノンフィクション', 'エッセイ', '随筆', '伝記', '自伝', '回顧録',
    'ルポ', 'ドキュメンタリー', '評伝', '体験記', 'memoir', 'essay',
    'biography', 'nonfiction',
  ],
  // ─── ビジネス/政治/社会 3分類 ────────────────────────────────
  'ビジネス・自己啓発': [
    'ビジネス・キャリア', '自己啓発・マインドフルネス',
    'ビジネス', '経営', 'マネジメント', 'マーケティング', '起業',
    'リーダーシップ', '自己啓発', 'キャリア', '仕事術',
    'コミュニケーション', '人間関係', 'スピリチュアル',
    '心理', '脳科学', '認知', '教養', 'business', 'psychology', 'management',
  ],
  '政治・経済': [
    '社会・政治', '人文・思想', '資産・金融',
    '政治', '経済', '金融', '投資', '資産',
...
const DETAIL_TAG_PATTERNS = {
  ...
  'ノンフィクション': [
    ...
    { tag: '政治・戦争',         words: ['政治', '戦争', '外交', '国際', '歴史', 'politics', 'war'] },
  ],
  'ビジネス・自己啓発': [
