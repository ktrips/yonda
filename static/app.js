...
const GENRE_NORMALIZE_MAP = {
  ...
  // 自伝・ノンフィクション（旧: 自伝・回顧録 + ノンフィクション を統合）
  '自伝・ノンフィクション':          '自伝・ノンフィクション',
  '自伝・回顧録':                     '自伝・ノンフィクション',  // 旧カテゴリ名 → 統合
  // ビジネス・キャリア
  'ビジネス・キャリア':               'ビジネス・キャリア',
...
const DETAIL_TAG_PATTERNS = {
  ...
  '自伝・ノンフィクション': [
    ...
    { tag: 'ルポ・ジャーナリズム', words: ['ルポ', 'ルポルタージュ', '取材', 'ジャーナリズム', '調査報道', 'ドキュメント'] },
    { tag: '社会・告発',           words: ['告発', '内部告発', '拘束', '収容', '裁判', '冤罪', 'スキャンダル', '腐敗'] },
    { tag: 'エッセイ・体験記',     words: ['エッセイ', '随筆', '体験記', '回顧録', '思い出', 'memoir'] },
  ],
  'ビジネス・キャリア': [
