...
const CATEGORY_TAG_BLOCKLIST = {
  ...
  '自伝・回顧録':                new Set(['自伝', '回顧録', '伝記', 'memoir', 'biography', '自伝・回顧録']),
  'ビジネス・キャリア':          new Set(['ビジネス', 'business', 'ビジネス・キャリア', 'キャリア', 'ノンフィクション', 'nonfiction', 'エッセイ', 'essay', '随筆', '新書', 'ドキュメンタリー']),
  '自己啓発・人間関係・子育て':  new Set(['自己啓発', 'self-help', '人間関係', '子育て', '新書', 'マインドフルネス']),
  '政治学・社会科学':            new Set(['政治', '社会', '政治学', '社会科学', '政治学・社会科学', 'ノンフィクション']),
...
const DETAIL_TAG_PATTERNS = {
  ...
  '自伝・回顧録': [
    { tag: 'ビジネスリーダー',     words: ['経営者', '起業家', 'ceo', '社長', 'ベンチャー', '創業', '会社'] },
    { tag: '政治家・官僚',         words: ['政治家', '総理', '大統領', '議員', '官僚', '外交', '政策'] },
    { tag: '文化人・芸術家',       words: ['芸術家', '作家', '音楽家', '俳優', '監督', '芸能人', '画家'] },
    { tag: '科学者・研究者',       words: ['科学者', '研究者', '博士', '教授', '発明', '発見', 'ノーベル'] },
    { tag: '歴史的人物',           words: ['歴史', '伝説', '偉人', '明治', '昭和', '戦国', '武将'] },
    { tag: '挑戦・逆境',           words: ['挑戦', '逆境', '失敗', '成功', '壁', '乗り越え', '転機', '再起'] },
  ],
  'ビジネス・キャリア': [
...
const CAT_COLORS = {
  ...
  '自伝・回顧録':                { read: '#8e7cc3', unread: '#c9bfe5' },
