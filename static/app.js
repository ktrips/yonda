...
const CATEGORY_TAG_BLOCKLIST = {
  ...
  'ノンフィクション':            new Set(['ノンフィクション', 'nonfiction', 'エッセイ', 'essay', '随筆', '伝記', 'ドキュメンタリー']),
  '自伝・回顧録':                new Set(['自伝', '回顧録', '伝記', 'memoir', 'biography', '自伝・回顧録']),
  'ビジネス・キャリア':          new Set(['ビジネス', 'business', 'ビジネス・キャリア', 'キャリア']),
  ...
  '科学・テクノロジー':          new Set(['テクノロジー', 'it', 'science', 'technology', '科学', '工学', '科学・工学', 'コンピュータ', 'コンピュータ・テクノロジー']),
};
...
const DETAIL_TAG_PATTERNS = {
  ...
  'ノンフィクション': [
    ...
    { tag: '犯罪・事件ルポ',       words: ['犯罪', '真実の事件', '実話', '冤罪', 'true crime', '事件の真相'] },
    ...
    { tag: '戦争・歴史証言',       words: ['戦争', '戦場', '証言', '記録', '歴史', '史実'] },
  ],
  '自伝・回顧録': [
  ...
  'ライフ': [
    ...
    { tag: '旅行・アウトドア',       words: ['旅行', '旅', 'アウトドア', '登山', '観光', 'travel'] },
    { tag: 'アート・デザイン',       words: ['アート', '美術', 'デザイン', 'クリエイティブ', '絵', '写真', '芸術', 'art'] },
    { tag: '音楽・映画・エンタメ',   words: ['音楽', '映画', 'エンタメ', '映像', '演劇', 'ライブ', 'アニメ', 'music'] },
  ...
  '科学・テクノロジー': [
    ...
    { tag: '物理・数学',               words: ['物理', '量子', '相対性', '素粒子', '数学', '論理', '確率', 'physics', 'math'] },
